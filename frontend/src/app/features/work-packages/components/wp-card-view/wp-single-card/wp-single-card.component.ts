...
export class WorkPackageSingleCardComponent extends UntilDestroyedMixin {
  ...
  public cardClasses() {
    let classes = this.selected ? checkedClassName : '';
  ...
  public cardHighlighting(wp:WorkPackageResource) {
